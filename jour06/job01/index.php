...
<body class="d-flex flex-column justify-content-center bg-secondary-light">
    <nav class="navbar navbar-expand-lg bg-light gap-3 bg-body-tertiary">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link" target="_blank" href="https://laplateforme.io/">Accueil</a>
              </li>
              <li class="nav-item">
    ...
    <main class="container d-flex justify-content-center align-items-center flex-column">
        ...
        <div class="row gx-2 gap-4">

            <div class="card px-0" style="width: 18rem;">
                <img src="images/butterfly-8325417_640.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Un Papillon</h5>
                    <p class="card-text">Un papillon, c'est un peu comme une chenille, mais avec des ailes. <br>Ne pas ingerer.
                    </p>
                    <a href="#" class="btn btn-primary">Commander votre propre papillon</a>
                </div>
            </div>
            <div class="jumbotron col-xxl-5 gx-2 p-3  bg-light">
        ...
        <div class="d-flex col-9 progessbar"> 
            <button><img src="images/fleche-gauche.png" alt=""></button>
            <div class="progress col-8" role="progressbar" aria-label="Warning striped example" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">
                <div class="progress-bar progress-bar-striped bg-warning" style="width: 75%"></div>
            </div>
            <button><img src="images/fleche-droite.png" alt=""></button>
        </div>
    </main>
    <footer class="row container-fluid pb-5 justify-content-evenly p-2">
        <article class="col-4">
            <p>Recevez votre copie gratuite d'internet 2!</p>
            <div class="col-auto">
                <label class="visually-hidden" for="autoSizingInputGroup">Login</label>
                <div class="input-group">
                  <div class="input-group-text bg-secondary">@</div>
                  <input type="text" class="form-control" id="autoSizingInputGroup" placeholder="Login">
                </div>
            </div>
            <div class="col-auto mt-2">
                <label class="visually-hidden" for="autoSizingInputGroup">Mot de passe</label>
                <div class="input-group">
                    <input type="text" class="form-control" id="autoSizingInputGroup" placeholder="Mot de passe">
                    <div class="input-group-text bg-secondary">@exemple.com</div>
                </div>
            </div>
            <br>
            <p>URL des Internets 2 et 2.1 Beta</p>
            <div class="col-auto">
                <label class="visually-hidden" for="autoSizingInputGroup">DogeCoin</label>
                <div class="input-group">
                  <div class="input-group-text bg-secondary">DogeCoin</div>
                  <input type="text" class="form-control" id="autoSizingInputGroup">
                  <div class="input-group-text bg-secondary">.00</div>
                </div>
            <div class="col-auto">
                <label class="visually-hidden" for="autoSizingInputGroup"></label>
                <div class="input-group">
                  <div class="input-group-text bg-secondary">https://l33t.lptf/dkwb/berlusconimkt/</div>
                  <input type="text" class="form-control" id="autoSizingInputGroup">
                </div>
